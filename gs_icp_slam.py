...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", help="dataset path", default="/home/zhaoyibin/3DRE/3DGS/GS_ICP_SLAM_ORIGIN/GS_ICP_SLAM/dataset/TUM/rgbd_dataset_freiburg1_desk")
    # parser.add_argument("--config", help="caminfo", default="configs/Replica/caminfo.txt")
    parser.add_argument("--config", help="caminfo", default="configs/TUM/rgbd_dataset_freiburg1_desk.txt")
    parser.add_argument("--output_path", help="output path", default="output/room0")
    # parser.add_argument("--keyframe_th", default=0.7)
    parser.add_argument("--keyframe_th", default=0.81)
    parser.add_argument("--knn_maxd", default=99999.0)
    parser.add_argument("--verbose", action='store_true', default=False)
    parser.add_argument("--demo", action='store_true', default=False)
    # parser.add_argument("--overlapped_th", default=5e-4)
    parser.add_argument("--overlapped_th", default=1e-3)
    # parser.add_argument("--max_correspondence_distance", default=0.02)
    parser.add_argument("--max_correspondence_distance", default=0.03)
    # parser.add_argument("--trackable_opacity_th", default=0.05)
    parser.add_argument("--trackable_opacity_th", default=0.09)
    # parser.add_argument("--overlapped_th2", default=5e-5)
    parser.add_argument("--overlapped_th2", default=1e-3)
    ...
    # parser = ArgumentParser(description="dataset_path / output_path / verbose")
    # parser.add_argument("--dataset_path", help="dataset path", default="dataset/Replica/room0")
    # # parser.add_argument("--dataset_path", help="dataset path", default="dataset/TUM/rgbd_dataset_freiburg1_desk")
    # parser.add_argument("--config", help="caminfo", default="configs/Replica/caminfo.txt")
    # # parser.add_argument("--config", help="caminfo", default="configs/TUM/rgbd_dataset_freiburg1_desk.txt")
    # parser.add_argument("--output_path", help="output path", default="output/room0")
    # parser.add_argument("--keyframe_th", default=0.7)
