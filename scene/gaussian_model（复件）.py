...
class GaussianModel(nn.Module):
    ...
    def import_camera_rt(self,q,t):
        self._camera_quaternion = nn.Parameter(q.requires_grad_(True))
        self._camera_t = nn.Parameter(t.requires_grad_(True))
    def trans_gaussian_camera(self):
        ...
        if True:
            ...
            transformed_rots = self.quat_mult(q, self._rotation)
